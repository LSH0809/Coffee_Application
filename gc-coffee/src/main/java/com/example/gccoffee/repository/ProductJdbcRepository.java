...
public class ProductJdbcRepository implements ProductRepository {
    ...
    public Product insert(Product product) {
        var update = namedParameterJdbcTemplate.update("INSERT INTO products(product_id,product_name,category,price,description, created_at, updated_at)" +
    ...
    public Product update(Product product) {
        var update = namedParameterJdbcTemplate.update(
                "UPDATE products SET description = :description, created_at = :createdAt, updated_at = :updatedAt" +
    ...
    public void deleteById(UUID productId) {
        ...
        paramMap.put("productId", productId.toString().getBytes());

        var delete = namedParameterJdbcTemplate.update("DELETE from products WHERE product_id = UUID_TO_BIN(:productId)", paramMap);
